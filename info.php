...
<head>
    ...
    <title>Informazioni PHP - EMANUELE VISMARA</title>
    <style>
        body {
...
<body>
    <div class='header'>
        ...
        <p>Configurazione del server PHP per EMANUELE VISMARA</p>
    </div>
    
    <div class='info-box'>
        <h2>📊 Dati Studente</h2>
        <p><strong>Nome:</strong> EMANUELE VISMARA</p>
        <p><strong>Classe:</strong> 5CINF</p>
        <p><strong>Username:</strong> vismara.emanuele</p>
